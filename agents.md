...
This project is indexed by GitNexus as **EMPLOYE TRACKER** (3068 symbols, 5578 relationships, 201 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/EMPLOYE TRACKER/context` | Codebase overview, check index freshness |
| `gitnexus://repo/EMPLOYE TRACKER/clusters` | All functional areas |
| `gitnexus://repo/EMPLOYE TRACKER/processes` | All execution flows |
| `gitnexus://repo/EMPLOYE TRACKER/process/{name}` | Step-by-step execution trace |
